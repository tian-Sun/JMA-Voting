          ...
          return (
            <Tooltip key={platform.platform}>
              <TooltipTrigger asChild>
                <Badge 
                  variant="outline" 
                  className={`text-xs px-2 py-1 ${platformColor} cursor-help`}
                >
                  {platformName}
                </Badge>
              </TooltipTrigger>
              <TooltipContent className="max-w-xs">
                <div className="text-center">
                  <div className="font-medium mb-2">{platformName}</div>
                  <div className="text-sm text-gray-600 mb-2">
                    {platform.votes.toLocaleString()} 票 ({percentage}%)
                  </div>
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <Badge 
            variant="outline" 
            className={`text-xs px-2 py-1 ${platformColor} cursor-help ${className}`}
          >
        ...
        <TooltipContent className="max-w-xs">
          <div className="text-center">
            <div className="font-medium mb-2">票数来源分布</div>
